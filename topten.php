...
$xoopsOption['template_main'] = 'booklists_topten.html';
...
$arr=array();
$result=$xoopsDB->query("select cid, title from ".$xoopsDB->prefix("booklists_cat")." where pid=0");
$e = 0;
$rankings = array();
while(list($cid, $ctitle)=$xoopsDB->fetchRow($result)){
	$rankings[$e]['title'] = sprintf(_MD_TOP10, $myts->htmlSpecialChars($ctitle));
	$query = "select lid, cid, title, hits, rating, votes from ".$xoopsDB->prefix("booklists_links")." where status>0 and (cid=$cid";
