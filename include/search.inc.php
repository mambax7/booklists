...
function booklists_search($queryarray, $andor, $limit, $offset, $userid){
	global $xoopsDB;
	$sql = "SELECT l.lid,l.cid,l.title,l.submitter,l.date,t.description FROM ".$xoopsDB->prefix("booklists_links")." l LEFT JOIN ".$xoopsDB->prefix("booklists_text")." t ON t.lid=l.lid WHERE status>0";
	if ( $userid != 0 ) {
